...
{
	public delegate void ServerUserDelegate(XG.Core.Server aServer, string aBot);
	...
	public class Download : AWorker
	{
		...
		public XG.Core.Server Server { get; set; }
		...
		public event EventHandler<EventArgs<XG.Core.Server, string>> OnConnected;
		public event EventHandler<EventArgs<XG.Core.Server, string>> OnDisconnected;
		public event EventHandler<EventArgs<XG.Core.Server, string>> OnReady;
		...
		protected void StartWriting()
		{
			...
			try
			{
				...
				if (OnConnected != null)
				{
					OnConnected(this, new EventArgs<XG.Core.Server, string>(Server, Bot));
				}
		...
		protected void StopWriting()
		{
			...
			if (_streamOk)
			{
				...
				if (CurrentSize == Size)
				{
					...
					if (OnReady != null)
					{
						OnReady(this, new EventArgs<XG.Core.Server, string>(Server, Bot));
					}
				}
			...
			{
				OnDisconnected(this, new EventArgs<XG.Core.Server, string>(Server, Bot));
			}
		}
