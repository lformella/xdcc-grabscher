	...
	formatPacketName: function (packet)
	{
		...
		if(packet.Connected == "true")
		{
			...
			ret += "<div role='progressbar' class='ui-progressbar ui-widget ui-widget-content ui-corner-all' style='height:3px'>" +
				...
				"<div style='width: " + b + "%;float:left;background:#" + (packet.IsChecked ? Enum.TangoColor.SkyBlue.Dark : Enum.TangoColor.Plum.Dark) + "' class='ui-progressbar-value ui-corner-left ui-widget-header'></div>" +
				"<div style='width: " + c + "%;float:left;background:#" + (packet.IsChecked ? Enum.TangoColor.SkyBlue.Light : Enum.TangoColor.Plum.Light) + "' class='ui-progressbar-value ui-corner-left ui-widget-header'></div>" +
