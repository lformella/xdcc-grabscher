...
/*#else
...
#if DEBUG
						content = content.Replace("#XGVERSION#", Settings.Default.XgVersion + " (beta)");
#else
						content = content.Replace("#XGVERSION#", Settings.Default.XgVersion);
#endif
					}
					...
					if (aFile == "/Resources/js/xg/config.js")
					{
						...
						content = content.Replace("#PORT#", "" + (Settings.Default.WebserverPort + 1));
