	...
	i18n.config(['$translateProvider',
		function ($translateProvider) {
			$translateProvider.translations('en', {
				...
				"Notification_Description_1": "The Packet {{Name}} of {{ParentName}} is complete",
				"Notification_Header_2": "Packet is not complete",
				"Notification_Description_2": "The Packet {{Name}} of {{ParentName}} is not complete",
				"Notification_Header_3": "Packet is broken",
				"Notification_Description_3": "The Packet {{Name}} of {{ParentName}} is broken",
				"Notification_Header_4": "Packet was requested",
				"Notification_Description_4": "The Packet {{Name}} of {{ParentName}} was requested",
				"Notification_Header_5": "Packet was removed",
				"Notification_Description_5": "The Packet {{Name}} of {{ParentName}} was removed",
				"Notification_Header_6": "File is complete",
				"Notification_Description_6": "The File {{Name}} is complete",
				"Notification_Header_7": "File has the wrong size",
				"Notification_Description_7": "The File {{Name}} has the wrong size",
				"Notification_Header_8": "Filecould not be build",
				"Notification_Description_8": "The File {{Name}} could not be build",
				"Notification_Header_9": "Server is connected",
				"Notification_Description_9": "The Server {{Name}} is connected",
				"Notification_Header_10": "Server could not be connected",
				"Notification_Description_10": "The Server {{Name}} could not be connected",
				"Notification_Header_11": "Channel joined",
				"Notification_Description_11": "I joined Channel {{Name}} of {{ParentName}}",
				"Notification_Header_12": "Channel could not be joined",
				"Notification_Description_12": "I could not join Channel {{Name}} of {{ParentName}}",
				"Notification_Header_13": "Channel is banned",
				"Notification_Description_13": "I was banned from Channel {{Name}} of {{ParentName}}",
				"Notification_Header_14": "Channel parted",
				"Notification_Description_14": "I parted Channel {{Name}} of {{ParentName}}",
				"Notification_Header_15": "Channel kicked",
				"Notification_Description_15": "I was kicked from Channel {{Name}} of {{ParentName}}",
				"Notification_Header_16": "Packet is downloading",
				"Notification_Description_16": "The Packet {{Name}} of {{ParentName}} is downloading",
				"Notification_Header_17": "Packet could not be downloaded",
				"Notification_Description_17": "The Packet {{Name}} of {{ParentName}} could not be downloaded",
				"Notification_Header_18": "Bot submitted wrong download port",
				"Notification_Description_18": "The Bot {{ParentName}} submitted wrong download port for packet {{Name}}"
			});
		}
	]);
});
