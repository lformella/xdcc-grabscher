...
namespace XG.Server.Plugin.Core.Irc.Test.Parser.Types
{
	[TestFixture()]
	public class XdccList : AParser
	{
		...
		{
			var parser = new Core.Irc.Parser.Types.XdccList();

			XG.Core.EventArgs<XG.Core.Server, string, string> raisedEvent1;
